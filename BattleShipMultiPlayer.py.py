...
array_Of_Ships_Objects1 = createShips()  # For User 1
array_Of_Ships_Objects2 = createShips()  # For User 2
...
print("For User1")
assignBoard(array_Of_Ships_Objects1,internal_board1)
print_board(internal_board1)
print()

#Assign and print board for User2
print("For User2")
assignBoard(array_Of_Ships_Objects2,internal_board2)
print_board(internal_board2)
print()
...
while(shipSunk1 != 4 or shipSunk2 != 4):
...
#                user = user2
        ...
        while (flagmiss != 1  ):
                ...
                for ship in array_Of_Ships_Objects2:
                                ...
                                for cell in ship.cellArray:
                                        if cell.x == x and cell.y == y :
                                                if cell.isHit == 0: 
                                                        ...
                                                        flag2 = 1
                                                        print("Hit!")
                                                        board1 = setShipOnScreen(board1,x, y)
                                                        #Sunk the ship if all cells are opened
                                                        if allCellOpened(ship) :
                                                                ship.isSunk = 1
                                                                print("You sank a ship")
                                                                print()
                                                                shipSunk1 += 1 # increment the shipsunk variable which is used for the base case of while loop 
                ...
                if allShipSunk(array_Of_Ships_Objects2):
                        print("You win! All Ships Have sunk")
                        print("Game Over")
                        print("Chances taken: ", count1)
                # if toggle == 1:
                #         toggle = 0
                # else:
                #         toggle = 1
